...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="card card-register mx-auto mt-5">
        <div class="card-header text-uppercase text-center">Consultar Entradas</div>
        <div class="card-body">
                ...
                <div class="modal-dialog modal-sm" style="max-width: 600px!important; min-width: 300px!important">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <%--Viewer--%>
                            <rsweb:ReportViewer ID="MyEntradasReportViewer" runat="server" ProcessingMode="Remote" Height="400px" Width="500px">
