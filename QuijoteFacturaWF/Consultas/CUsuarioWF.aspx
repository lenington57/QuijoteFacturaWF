<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CUsuarioWF.aspx.cs" Inherits="QuijoteFacturaWF.Consultas.CUsuarioWF" %>
                ...
                <div class="modal-dialog modal-sm" style="max-width: 600px!important; min-width: 300px!important">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <%--Viewer--%>
                            <rsweb:ReportViewer ID="MyUsuariosReportViewer" runat="server" ProcessingMode="Remote" Height="400px" Width="500px">
